...
# PLAN mode (nominally read-only) could delegate destructive work even after
# the general-purpose subagent got coderio middleware (defense in depth).
DESTRUCTIVE_TOOLS = {"write_file", "edit_file", "multi_edit", "execute", "web_fetch", "note", "task"}
