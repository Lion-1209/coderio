...
class StreamHandler(Protocol):
    ...
    # Optional hooks (have_attr guards in run_step; NullStream implements them too):
...
class NullStream:
    ...
    def on_step_start(self) -> None: pass
    def on_token(self, text: str) -> None: pass
    def on_tool_start(self, name: str, args: dict[str, Any]) -> None: pass
